...
public class DinnerEvent extends Event{
    ...
    private static final String[] dessertChoices = {"Angel food cake", "Brownies", "Chocolate chip cookies",
            "Peach cobbler"};
    //Array to hold the employee objects for the event
    ...
    public DinnerEvent(String eventNum, int numGuests, String phoneNum, int entreeInput, int side1Input, int side2Input,
                       int dessertInput) {
    ...
    public void setEmployees(Employee employee, int position) {
